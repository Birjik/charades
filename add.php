<?php
    function okw($str){
    	for($l = 0;$l < strlen($str);++ $l){
    		...
    		if('ј' <= $str[$l] && $str[$l] <= 'я')return true;
    		if('а' <= $str[$l] && $str[$l] <= '€')return true;
...
<html>
	...
	<body>
		<div id="all">
			...
			<div id="content">
				<div id="center"><span id="str">ѕодготовление игры є<?php if($prepare==0)echo $next;else echo $prepare;?></span></div>
