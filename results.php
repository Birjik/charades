...
?>    	
	<div class = "message">
			...
			<form action = "results.php" method = "post">
			 	<input type="submit" name="END" value="ƒа">
				<input type="submit" name="NO" value="Ќет">
			</form>
	</div>			
<?php 
    }
...
<?php
	$winners = "";
  	$m = new mysqli("localhost","root","","archive_crocodile");			
	$m -> query("SET NAMES 'cp1251'");
	echo "<br><img width='80px' height='80px' src='images/cup.jpg'><span style='font-family:Comic Sans MS; font-size:300%'> „емпионы </span><img width='80px' height='80px' src='images/cup.jpg'><br><br>";
	$fst = $KOL[1] + $KOL2[1];
	for($t = 1;$t <= $n;++ $t){
		$ob = $KOL[$t] + $KOL2[$t];
	    if($ob < $fst)break;
...
<tr id="fst"><td>ћесто</td><td>Команда</td><td>Тур 1</td><td>Тур 2</td><td>Общий</td></tr>
<?php
for($i = 1;$i <= $n;++ $i){
$ob = $KOL[$i] + $KOL2[$i];
echo "<tr id='other'>
